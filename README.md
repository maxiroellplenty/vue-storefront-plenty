...
```sh
grep -rl 'plentysystems' ./ | xargs sed -i '' 's/plentysystems/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with plentysystems
...
Want to contribute? Ping us on `plentysystems` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/plentysystems.git
    cd plentysystems
    ```
...
- [plentysystems integration Documentation](https://docs.vuestorefront.io/plentysystems)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `plentysystems` channel on [our Discord](discord.vuestorefront.io).
